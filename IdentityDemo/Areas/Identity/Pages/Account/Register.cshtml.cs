...
namespace IdentityDemo.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private AppUsers AppUsers()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Data.AppUsers)}'. " +
                    $"Ensure that '{nameof(Data.AppUsers)}' is not an abstract class and has a parameterless constructor, or alternatively " +
